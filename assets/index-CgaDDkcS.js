...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function Va(){return new ve({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qr(),fragmentShader:`
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function ka(){return new ve({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qr(),fragmentShader:`
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	...
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new em(this,t,e,n)}addFolder(t){const e=new na({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof tr||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof tr)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}let jo=new na,Ti={distanceAffection:16,avoidanceDistance:30};jo.add(Ti,"distanceAffection",4,16,1);jo.add(Ti,"avoidanceDistance",-30,30,1);class om{constructor(t,e){let n=new fi({color:16777215});this.mesh=new De(new Pi(.1,.1),n),this.pivot=e,this.isAvoiding=!1,this.lerpFactor=0,this.velocityX=0,this.velocityY=0,this.lerpSpeed=.05,this.isAvoiding=!1,this.radius=t,this.targetPos=new L}avoidMouse(t){let e=new L,n=new L;if(this.mesh.getWorldPosition(e),this.pivot.getWorldPosition(n),n.setZ(0),n.distanceTo(t)<Ti.distanceAffection){let r=new L(n.x-t.x,n.y-t.y);r.normalize(),this.targetPos.x=r.x*(Ti.avoidanceDistance-this.radius),this.targetPos.y=r.y*(Ti.avoidanceDistance-this.radius),this.isAvoiding||(this.lerpFactor=0,this.isAvoiding=!0)}else this.isAvoiding&&(this.isAvoiding=!1,this.lerpFactor=0),this.targetPos.copy(new L)}controlMovement(){this.mesh.position.lerp(this.targetPos,this.lerpFactor),this.lerpFactor<1&&(this.lerpFactor+=this.lerpSpeed)}}const Zo=new Tp,mi=new yp;var Zn=new Mt;mi.setSize(window.innerWidth,window.innerHeight);const en=new Re(75,window.innerWidth/window.innerHeight,.1,1e3),Jo=new Cp(en,mi.domElement);Jo.enableRotate=!1;document.body.appendChild(mi.domElement);const ia=new Yp(mi),lm=new $p(Zo,en);ia.addPass(lm);const cm=new ui;ia.addPass(cm);document.addEventListener("mousemove",hm,!1);function hm(i){i.preventDefault(),Zn.x=i.clientX/window.innerWidth*2-1,Zn.y=-(i.clientY/window.innerHeight)*2+1;var t=new L(Zn.x,Zn.y,.5);t.unproject(en);var e=t.sub(en.position).normalize(),n=-en.position.z/e.z;Zn=en.position.clone().add(e.multiplyScalar(n))}window.addEventListener("resize",um,!1);function um(){en.aspect=window.innerWidth/window.innerHeight,en.updateProjectionMatrix(),mi.setSize(window.innerWidth,window.innerHeight)}let cs=[],Qo=new ti;var tl=new De(new ta(8,64,64),new fi);let fo=tl.geometry.attributes.position;for(let i=0;i<fo.count;i++){const t=new L;t.fromBufferAttribute(fo,i);const e=t.clone().applyMatrix4(tl.matrixWorld);let n=new ti;n.position.copy(e);let s=new om(10,n);s.mesh.material=new fi({color:16361068}),cs.push(s),n.add(s.mesh),s.mesh.position.copy(new L),Qo.add(n)}Zo.add(Qo);en.position.z=35;function dm(){for(let i=0;i<cs.length;i++)cs[i].avoidMouse(Zn),cs[i].controlMovement();ia.render(),Jo.update()}mi.setAnimationLoop(dm);
